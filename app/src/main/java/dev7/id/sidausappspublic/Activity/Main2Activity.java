...
public class Main2Activity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        rvUsaha.setLayoutManager(new LinearLayoutManager(Main2Activity.this));
        ...
        call.enqueue(new Callback<List<Usaha>>() {
            ...
            public void onResponse(Call<List<Usaha>> call, Response<List<Usaha>> response) {
                ...
                if (response.isSuccessful() && response !=null){
                    ...
                    adapterUsaha = new AdapterUsaha(usahas, desas, kecs, Main2Activity.this);
    ...
    private final String getToken() {
        SharedPreferences SharedPreferences = Main2Activity.this.getSharedPreferences("USER", MODE_PRIVATE);
